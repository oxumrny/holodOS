...
| Прототип визуала | ветка **`cursor/ios-design-prototype`**, тег **`ios-design-prototype-v1`** — архив; **не мержить целиком** |
| UI сейчас | системный iOS; кастом с прототипной ветки — только по явному запросу, точечно |
...
| позже | рецепты | |
| позже | кастомный дизайн по референсам | исходник: `cursor/ios-design-prototype` / тег `ios-design-prototype-v1` |
